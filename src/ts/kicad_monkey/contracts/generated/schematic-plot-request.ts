...
export interface SchematicPlotRequestA0 {
  ...
  max_polylines: number;
  max_arcs: number;
  max_circles: number;
  max_rectangles: number;
  max_beziers: number;
  max_rule_areas: number;
  max_images: number;
  max_tables: number;
  max_table_cells: number;
  max_table_cell_lines: number;
  max_image_data_parts: number;
  max_image_encoded_bytes: string;
  max_image_decoded_bytes: string;
  max_image_width_px: number;
  ...
  max_sheets: number;
  max_sheet_properties: number;
  max_sheet_pins: number;
