...
PUBLIC_API_EXPORTS: tuple[PublicApiExport, ...] = (
    ...
    PublicApiExport("KiCadNativeSvg", PublicApiStratum.PROJECT),
    PublicApiExport("kicad_native_handshake", PublicApiStratum.PROJECT),
    PublicApiExport("kicad_native_handshake_a1", PublicApiStratum.PROJECT),
    PublicApiExport("kicad_native_handshake_a2", PublicApiStratum.PROJECT),
    PublicApiExport("native_design_facts", PublicApiStratum.PROJECT),
    PublicApiExport("native_design_facts_a1", PublicApiStratum.PROJECT),
    PublicApiExport("native_design_facts_for_design", PublicApiStratum.PROJECT),
    PublicApiExport("native_render_svg", PublicApiStratum.PROJECT),
    ...
    PublicApiExport("FootprintPadSizeNormalization", PublicApiStratum.UTILITIES),
    PublicApiExport("PadSizeNormalizationChange", PublicApiStratum.UTILITIES),
    PublicApiExport("normalize_unsafe_footprint_pad_sizes", PublicApiStratum.UTILITIES),
