...
///Metadata paired with separate schematic plotter-IR JSON bytes.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
///{
///  "$id": "urn:wavenumber:schema:kicad_monkey.schematic_plot.result:a0",
///  "title": "Schematic plot result a0",
///  "description": "Metadata paired with separate schematic plotter-IR JSON bytes.",
///  "type": "object",
///  "required": [
///    "diagnostics",
///    "output_bytes",
...
///    "type": {
///      "type": "string",
///      "const": "kicad_monkey.schematic_plot.result"
///    },
///    "version": {
///      "type": "string",
///      "const": "a0"
...
#[derive(::serde::Deserialize, ::serde::Serialize, Clone, Debug)]
#[serde(deny_unknown_fields)]
pub struct SchematicPlotResultA0 {
