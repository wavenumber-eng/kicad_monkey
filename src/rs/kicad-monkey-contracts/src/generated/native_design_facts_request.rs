...
///  "title": "Native design facts request a0",
///  "description": "Strict request for the native compiled-graph and version-E netlist operation.",
///  "type": "object",
///  "required": [
///    "bundle_root",
///    "file_slots",
...
#[derive(::serde::Deserialize, ::serde::Serialize, Clone, Debug)]
#[serde(deny_unknown_fields)]
pub struct NativeDesignFactsRequestA0 {
