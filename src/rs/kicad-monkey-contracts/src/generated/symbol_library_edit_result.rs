...
///  "title": "Symbol library edit result a0",
///  "description": "Edit metadata paired with a separate resulting KiCad byte buffer.",
///  "type": "object",
///  "required": [
///    "changed",
///    "diagnostics",
...
///    "type": {
///      "type": "string",
///      "const": "kicad_monkey.symbol_library_edit.result"
///    },
///    "version": {
///      "type": "string",
///      "const": "a0"
...
#[derive(::serde::Deserialize, ::serde::Serialize, Clone, Debug)]
#[serde(deny_unknown_fields)]
pub struct SymbolLibraryEditResultA0 {
    pub changed: bool,
