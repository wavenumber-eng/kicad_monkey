...
pub struct SchematicDesignNetLimits {
    ...
    pub max_design_bus_aliases: usize,
    pub max_bus_subgraphs: usize,
    pub max_bus_members: usize,
    pub max_bus_indexed_coords: usize,
    pub max_bus_mapping_work_bytes: usize,
    pub max_bus_member_union_work: usize,
    pub max_bus_overrides: usize,
    pub max_bus_override_refs: usize,
    pub max_bus_override_string_bytes: usize,
...
impl Default for SchematicDesignNetLimits {
    fn default() -> Self {
        Self {
            ...
            max_design_bus_aliases: 1_000_000,
            max_bus_subgraphs: 8_000_000,
            max_bus_members: 16_000_000,
            max_bus_indexed_coords: 32_000_000,
            max_bus_mapping_work_bytes: 1024 * 1024 * 1024,
            max_bus_member_union_work: 128_000_000,
            max_bus_overrides: 8_000_000,
            max_bus_override_refs: 16_000_000,
            max_bus_override_string_bytes: 1024 * 1024 * 1024,
