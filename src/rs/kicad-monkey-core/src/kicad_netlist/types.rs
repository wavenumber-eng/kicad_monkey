...
pub struct KiCadNetlistLimits {
    ...
    pub max_expanded_string_bytes: usize,
    pub max_variable_expansion_work_bytes: usize,
    pub max_libparts: usize,
    pub max_libpart_pins: usize,
    pub max_sheets: usize,
    pub max_wildcard_match_work: usize,
...
impl Default for KiCadNetlistLimits {
    fn default() -> Self {
        Self {
            ...
            max_expanded_string_bytes: 64 * 1024 * 1024,
            max_variable_expansion_work_bytes: 1024 * 1024 * 1024,
            max_libparts: 1_000_000,
            max_libpart_pins: 16_000_000,
            max_sheets: 8_000_000,
            max_wildcard_match_work: 1_000_000_000,
