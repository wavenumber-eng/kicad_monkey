...
pub struct SchematicBundleLimits {
    ...
    pub max_page_instances_per_source: usize,
    pub max_page_instance_bytes_per_source: usize,
    pub max_sheet_properties: usize,
    pub max_sheet_pins_per_sheet: usize,
    pub max_title_block_children_per_source: usize,
    pub max_title_block_comments_per_source: usize,
    ...
    pub max_library_properties_per_symbol: usize,
    pub max_library_subsymbols_per_source: usize,
    pub max_library_pins_per_source: usize,
    pub max_jumper_groups_per_source: usize,
    pub max_jumper_members_per_source: usize,
    pub max_jumper_member_bytes_per_source: usize,
...
impl Default for SchematicBundleLimits {
    fn default() -> Self {
        Self {
            ...
            max_page_instances_per_source: 4_000_000,
            max_page_instance_bytes_per_source: 64 * 1024 * 1024,
            max_sheet_properties: 1_000_000,
            max_sheet_pins_per_sheet: 1_000_000,
            max_title_block_children_per_source: 4_096,
            max_title_block_comments_per_source: 1_024,
            ...
            max_library_properties_per_symbol: 1_000_000,
            max_library_subsymbols_per_source: 4_000_000,
            max_library_pins_per_source: 8_000_000,
            max_jumper_groups_per_source: 1_000_000,
            max_jumper_members_per_source: 8_000_000,
            max_jumper_member_bytes_per_source: 256 * 1024 * 1024,
