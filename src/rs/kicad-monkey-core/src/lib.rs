...
pub use pcb_authoring::{
    ...
    AuthoredFrontBackPolicy, AuthoredGraphic, AuthoredGraphicGeometry, AuthoredKeepout,
    AuthoredLayer, AuthoredModel, AuthoredNet, AuthoredNetRef, AuthoredPad, AuthoredPadAnchor,
    AuthoredPadKind, AuthoredPadPolygonPoint, AuthoredPadPrimitive, AuthoredPadPrimitiveFill,
    AuthoredPadPrimitiveGeometry, AuthoredPadShape, AuthoredPadstack, AuthoredPadstackLayer,
    AuthoredPadstackLayerSelector, AuthoredPadstackMode, AuthoredPadstackZoneConnection,
    AuthoredPcb, AuthoredPlacementConstraint, AuthoredPlacementSource, AuthoredPoint,
    AuthoredProperty, AuthoredResourceData, AuthoredRestriction, AuthoredRoutingArc,
    AuthoredRuleArea, AuthoredSegment, AuthoredSetup, AuthoredStackup, AuthoredStackupLayer,
