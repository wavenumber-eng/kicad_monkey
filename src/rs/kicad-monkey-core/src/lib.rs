...
pub use pcb_authoring::{
    ...
    AuthoredPlacementSource, AuthoredPoint, AuthoredPolygonPoint, AuthoredProperty,
    AuthoredResourceData, AuthoredRestriction, AuthoredRoutingArc, AuthoredRuleArea,
    ...
    AuthoredViaKind, AuthoredViaStack, AuthoredViaStackLayer, AuthoredZone, AuthoredZoneConnection,
    AuthoredZoneFill, AuthoredZoneFilledPolygon, AuthoredZoneHatch, AuthoredZonePadConnection,
    AuthoredZonePolygon, KICAD_SOURCE_VERSION_2024_12_29, PcbAuthoringLimits,
};
