...
pub use pcb::{
    ...
    PcbPadPrimitiveGeometry, PcbPadstack, PcbPadstackLayer, PcbPoint, PcbPolygonPoint,
    PcbPostMachiningProperties, PcbProfileOwner, PcbProfilePrimitive, PcbProperty,
    PcbResolvedPadCopperLayer, PcbRoutingArc, PcbSegment, PcbSelection, PcbSetup, PcbStackup,
    PcbStackupLayer, PcbTable, PcbTableCell, PcbTeardropParameters, PcbVia, PcbViaStack,
    PcbViaStackLayer, PcbView, PcbZone, PcbZoneFilledPolygon, PcbZoneKeepout,
    PcbZoneLayerConnections, PcbZoneLayerProperty, PcbZonePlacement, PcbZonePlacementSource,
    PcbZonePolygon, resolve_pad_copper_layer,
};
pub use pcb_authoring::{
    ...
    AuthoredFootprintOccurrence, AuthoredFootprintProperty, AuthoredFootprintText,
    AuthoredFrontBackPolicy, AuthoredGraphic, AuthoredGraphicGeometry, AuthoredGroup,
    AuthoredKeepout, AuthoredLayer, AuthoredModel, AuthoredNet, AuthoredNetRef, AuthoredPad,
    AuthoredPadAnchor, AuthoredPadKind, AuthoredPadPolygonPoint, AuthoredPadPrimitive,
    AuthoredPadPrimitiveFill, AuthoredPadPrimitiveGeometry, AuthoredPadShape, AuthoredPadstack,
    AuthoredPadstackLayer, AuthoredPadstackLayerSelector, AuthoredPadstackMode,
    AuthoredPadstackZoneConnection, AuthoredPcb, AuthoredPlacementConstraint,
    AuthoredPlacementSource, AuthoredPoint, AuthoredProperty, AuthoredResourceData,
    AuthoredRestriction, AuthoredRoutingArc, AuthoredRuleArea, AuthoredSegment, AuthoredSetup,
    AuthoredStackup, AuthoredStackupLayer, AuthoredStandaloneFootprint, AuthoredTextBox,
    AuthoredTextBoxGeometry, AuthoredTextEffects, AuthoredTextHorizontalJustification,
    AuthoredTextVerticalJustification, AuthoredVia, AuthoredViaKind, AuthoredViaStack,
    AuthoredViaStackLayer, AuthoredZone, AuthoredZoneConnection, AuthoredZoneFill,
...
pub use schematic_plotter_ir::{
    ...
    SchematicGraphicRecord, SchematicGraphicRecordKind, SchematicImageRecord,
    SchematicPlotBuildProfile, SchematicPlotContext, SchematicPlotDocument, SchematicPlotLimits,
    SchematicPlotOperation, SchematicPlotRecord, SchematicPlotVariables, SchematicRuleAreaRecord,
    SchematicRuleAreaShape, SchematicSheetHeaderRecord, SchematicSheetPinAttrs,
    SchematicSheetPinBlock, SchematicSheetRecord, SchematicStyledThickSegment,
    SchematicSymbolInstanceRecord, SchematicSymbolOverplotRecord, SchematicSymbolPinAttrs,
    SchematicSymbolPinBlock, SchematicTableRecord, SchematicTextOperation, SchematicTitleBlock,
