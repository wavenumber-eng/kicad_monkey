...
pub use pcb_authoring::{
    ...
    AuthoredFootprintOccurrence, AuthoredFootprintProperty, AuthoredFootprintScalarProperty,
    AuthoredFootprintText, AuthoredFrontBackPolicy, AuthoredGraphic, AuthoredGraphicGeometry,
    AuthoredGroup, AuthoredKeepout, AuthoredLayer, AuthoredModel, AuthoredNet, AuthoredNetRef,
