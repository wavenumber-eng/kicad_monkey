...
Accepted architecture decisions for `kicad-cruncher` live in this directory.

- [ADR-0001: Versioning, Tagging, Release Policy](ADR-0001-versioning-tagging-release-policy.md)
- [ADR-0002: CLI Install And Dependency Discipline](ADR-0002-cli-install-and-dependency-discipline.md)
- [ADR-0003: Documentation Lifecycle And Release Boundary](ADR-0003-documentation-lifecycle-and-release-boundary.md)
...
- [ADR-0009: Pure-Rust Canonical CLI](ADR-0009-pure-rust-canonical-cli.md)
