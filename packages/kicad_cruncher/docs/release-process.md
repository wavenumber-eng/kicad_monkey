...
git checkout main
git pull --ff-only
git tag -a kicad-monkey-v2026.9.1 -m "Release kicad-monkey 2026.9.1"
git tag -a kicad-cruncher-v2026.9.1 -m "Release kicad-cruncher 2026.9.1"
git push origin kicad-monkey-v2026.9.1 kicad-cruncher-v2026.9.1
```
...
`2026.9.1.1`; do not move a published tag.
