...
git checkout main
git pull --ff-only
git tag -a kicad-monkey-v2026.8.31 -m "Release kicad-monkey 2026.8.31"
git tag -a kicad-cruncher-v2026.8.31 -m "Release kicad-cruncher 2026.8.31"
git push origin kicad-monkey-v2026.8.31 kicad-cruncher-v2026.8.31
```
...
`2026.8.31.1`; do not move a published tag.
